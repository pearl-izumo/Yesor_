...
{ 
  ...
  let now_open = -1;
  let qcount = 0;
  let ans = Math.floor(Math.random()*134)+1; //attention
  let hard = -1;
  ...
  const YandN = ["YES","NO"];
  const CD = [1,2,5,8,5,6,3];
  const CD2 = [6,14,25,27,22,25,15];
  const CD3 = [[6],[7,7],[2,6,2,13,2],[2,6,2,3,6,6,1,1],[6,1,1,6,8],[1,7,1,13,2,1],[2,6,7]];
